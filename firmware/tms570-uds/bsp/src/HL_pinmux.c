...
/* USER CODE END */
	...
	pinMuxReg->PINMUX[5] = 0;
	
	pinMuxReg->PINMUX[6] = 0;
	
	pinMuxReg->PINMUX[7] = 0;
	...
	pinMuxReg->PINMUX[19] = PINMUX_BALL_C1_N2HET2_00 | PINMUX_BALL_E1_GIOA_3 | PINMUX_BALL_B5_GIOA_5 | PINMUX_BALL_H3_GIOA_6;
	...
	pinMuxReg->PINMUX[80] = SIGNAL_AD2EVT_T10;

	pinMuxReg->PINMUX[81] = 0;

	pinMuxReg->PINMUX[82] = 0;
...
/* USER CODE END */
    ...
    /* Route GIOB[2:7] balls to the GIO peripheral (not NHET2). The LaunchPad
     * onboard user LEDs sit on GIOB[6]/GIOB[7]. */

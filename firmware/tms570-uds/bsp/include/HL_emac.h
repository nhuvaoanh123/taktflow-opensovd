...
#define EMAC_MACSRCADDRHI_CONFIGVALUE ((uint32)((uint32)0xABU << 24U) | (uint32)((uint32)0xCBU << 16U) | (uint32)((uint32)0x2BU << 8U) | (uint32)((uint32)0x78U))
#define EMAC_MACSRCADDRLO_CONFIGVALUE ((uint32)((uint32)0x6DU << 8U) | (uint32)((uint32)0x2BU))

    ...
    */
    {
        ...
        0x00058203U,
        /* Control */
        (0x00008007U | (1U << 22U) | (31U << 8U) | (3U << 3U)),
        /* Data */
        80128U,
        /* Reserved */
        0x00000000U
    ...
    */
    {
        ...
        0x0005C205U,
        /* Control */
        (0x0000C007U | (1U << 22U) | (17U << 8U) | (3U << 3U)),
        /* Data */
        80128U,
        /* Reserved */
        0x00000000U
    ...
    */
    {
        ...
        0x00060207U,
        /* Control */
        (0x00010007U | (1U << 22U) | (25U << 8U) | (3U << 3U)),
        /* Data */
        80128U,
        /* Reserved */
        0x00000000U
    ...
    */
    {
        ...
        0x00064209U,
        /* Control */
        (0x00014007U | (1U << 22U) | (18U << 8U) | (3U << 3U)),
        /* Data */
        80128U,
        /* Reserved */
        0x00000000U
    ...
    */
    {
        ...
        0x0006820BU,
        /* Control */
        (0x00018007U | (1U << 22U) | (29U << 8U) | (3U << 3U)),
        /* Data */
        80128U,
        /* Reserved */
        0x00000000U
    ...
    */
    {
        ...
        0x0006C20DU,
        /* Control */
        (0x0001C007U | (1U << 22U) | (27U << 8U) | (3U << 3U)),
        /* Data */
        80128U,
        /* Reserved */
        0x00000000U
    ...
    */
    {
        ...
        0x0007020FU,
        /* Control */
        (0x00020007U | (1U << 22U) | (05U << 8U) | (3U << 3U)),
        /* Data */
        80128U,
        /* Reserved */
        0x00000000U
...
/* USER CODE END */
    ...
    *     - Enable HET
    */
    hetREG1->GCR = (0x01020001U | (uint32)(1U << 16U));


  /** @b initialize @b HET 2 */

    /** - Set HET pins default output value */
    hetREG2->DOUT = (uint32)(0U << 31U)
                 | (uint32)(0U << 30U)
                 | (uint32)(0U << 29U)
                 | (uint32)(0U << 28U) 
                 | (uint32)(0U << 27U)  
...
/* USER CODE END */
    ...
    *     - Enable HET
    */
    hetREG2->GCR = (0x01020001U | (uint32)(1U << 16U));
...
void pwmSetSignal(hetRAMBASE_t * hetRAM, uint32 pwm, hetSIGNAL_t signal)
{
    ...
    if(hetRAM == hetRAM1)
    {
        pwmPeriod = (uint32)((signal.period * 1000.0) / (uint32) 800.000) << 7U;
        pwmPolarity = s_het1pwmPolarity[pwm];
    }
    else
    {
    ...
    hetRAM->Instruction[(pwm << 1U) + 41U].Control = ((hetRAM->Instruction[(pwm << 1U) + 41U].Control) & (~(0x00000018U))) | (action << 3U);
    hetRAM->Instruction[(pwm << 1U) + 41U].Data = (uint32)((pwmPeriod * signal.duty) / 100) + 128U;
...
void pwmGetSignal(hetRAMBASE_t * hetRAM, uint32 pwm, hetSIGNAL_t* signal)
{
    ...
    if(hetRAM == hetRAM1)
    {
        signal->period = ((pwmPeriod >> 7U) * (uint32) 800.000) / 1000;
    }
    else
    {
        signal->period = ((pwmPeriod >> 7U) * (uint32) 800.000) / 1000;

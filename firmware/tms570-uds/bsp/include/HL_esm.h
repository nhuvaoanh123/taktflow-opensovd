...
/** @typedef esmGroupChannel_t
*   @brief ESM Channels in Group
*
*   This type is used to represent ESM Channels in each group.
*/
typedef struct esmGroupChannels
{
    uint32 channel_00_31;
	uint32 channel_32_63;
	uint32 channel_64_95;
}esmGroupChannels_t;
...
#define ESM_EEPAPR1_CONFIGVALUE	((1U << 31U)\
                      | (0U << 30U)\
                      | (0U << 29U)\
                      | (0U << 28U)\
                      | (0U << 27U)\
                      ...
                      | (0U <<  1U)\
                      | (0U))
#define ESM_IESR1_CONFIGVALUE	((1U << 31U)\
                       | (0U << 30U)\
                       | (0U << 29U)\
                       | (0U << 28U)\
                       | (0U << 27U)\
                       ...
                       | (0U <<  1U)\
                       | (0U))
#define ESM_ILSR1_CONFIGVALUE ((1U << 31U)\
                       | (0U << 30U)\
                       | (0U << 29U)\
                       | (0U << 28U)\
                       | (0U << 27U)\
...
#define ESM_IEPSR4_CONFIGVALUE ((0U << 31U)\
                      | (0U << 30U)\
                      | (0U << 29U)\
                      | (0U << 28U)\
                      | (0U << 27U)\
                      ...
                      | (0U <<  1U)\
                      | (0U))
#define ESM_IESR4_CONFIGVALUE ((0U << 31U)\
                       | (0U << 30U)\
                       | (0U << 29U)\
                       | (0U << 28U)\
                       | (0U << 27U)\
                       ...
                       | (0U <<  1U)\
                       | (0U))
#define ESM_ILSR4_CONFIGVALUE ((0U << 31U)\
                       | (0U << 30U)\
                       | (0U << 29U)\
                       | (0U << 28U)\
                       | (0U << 27U)\

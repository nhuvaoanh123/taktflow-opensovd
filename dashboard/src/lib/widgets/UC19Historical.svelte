...
<script lang="ts">
	...
	const DEFAULT_URL = 'http://localhost:3000/d/sovd-hil/taktflow-sovd-hil?kiosk';
	...
	<div class="rounded-lg border border-border bg-card p-3">
		...
		{:else}
			<div class="flex h-40 flex-col items-center justify-center rounded border border-dashed border-border text-center text-xs text-muted-foreground">
				...
				<p class="mt-1">Set <code class="font-mono">VITE_GRAFANA_URL</code> env var to wire up.</p>
